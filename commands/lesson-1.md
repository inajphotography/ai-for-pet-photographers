...
I literally referenced [call out 2 to 3 specific callbacks: their location, their ideal client, their style, their offer].

That's because I read your CLAUDE.md before responding.

**And I'll do that every single time.** Every conversation. Every project. Every command.
